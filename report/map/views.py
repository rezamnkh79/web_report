...
def Code(request):
    ...
    return render(request, 'map/Code.html',context=context)
...
def LAC(request):
    ...
    # temp = send_data()
    context.update(points)
    return render(request, 'LAC.html',context=context)
...
def PingTest(request):
    ...
    # temp = send_data()
    context.update(points)
    return render(request, 'test//test_map.html',context=context)
